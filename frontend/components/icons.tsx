...
export const GoogleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" {...props}>
        ...
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.999,36.661,44,31.1,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
    </svg>
);
...
export const ChatBubbleLeftRightIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  ...
  >
    ...
    <path d="M18 5L21 2" className="opacity-70" />
    <path d="M6 5L3 2" className="opacity-70" />
  </svg>
);
...
export const SunIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-4.95-4.243-1.591 1.591M5.25 12H3m4.243-4.95L6.364 5.636M12 12a2.25 2.25 0 0 0-2.25 2.25c0 1.242 1.008 2.25 2.25 2.25s2.25-1.008 2.25-2.25A2.25 2.25 0 0 0 12 12Z" />
    </svg>
);
...
// New icons added for the improved components
...
// Alias for FiLoader to match the improved auth component
export const FiLoader = LoaderIcon;
// Alias for FiX to match the improved auth component  
export const FiX = XIcon;
// Alias for other Feather icons used in the improved components
export { 
  EyeIcon as FiEye,
  EyeSlashIcon as FiEyeOff,
  CheckIcon as FiCheck,
  ClipboardIcon as FiClipboard,
  UserIcon as FiUser,
  EnvelopeIcon as FiMail,
  LockClosedIcon as FiLock,
  MoonIcon as FiMoon,
  SunIcon as FiSun,
